...
const backgrounds = [
  ...
  { id: '1', path: background2, alt: 'Background 2' },
  { id: '2', path: background3, alt: 'Background 3' },
  { id: '3', path: background4, alt: 'Background 4' },
  { id: '4', path: background5, alt: 'Background 5' },
  { id: '5', path: background6, alt: 'Background 6' },
  { id: '6', path: background7, alt: 'Background 7' },
  { id: '7', path: background8, alt: 'Background 8' },
  { id: '8', path: background9, alt: 'Background 9' },
  { id: '9', path: background10, alt: 'Background 10' },
  { id: '10', path: background11, alt: 'Background 11' },
  { id: '11', path: background12, alt: 'Background 12' },
  { id: '12', path: background13, alt: 'Background 13' },
  { id: '13', path: background14, alt: 'Background 14' },
  { id: '14', path: background15, alt: 'Background 15' },
  { id: '15', path: background16, alt: 'Background 16' },
];
